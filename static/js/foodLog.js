...
function exportToExcel() {
  ...
  // Add worksheet for nutrition data
  const nutritionDataWS = XLSX.utils.table_to_sheet(document.getElementById('foodtable'));
  XLSX.utils.book_append_sheet(wb, nutritionDataWS, 'Nutrition Data');

  // Add worksheet for chart data (if applicable)
  // Extract chart data and create worksheet
